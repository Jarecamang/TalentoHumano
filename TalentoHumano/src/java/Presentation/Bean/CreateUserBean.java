...
public class CreateUserBean {
    ...
    public void createUser() {
        ...
        if (contractType.equals("Indefinido") && contractFinalDate != null) {
            ...
            String messageTest = createUser.doCreate(userDAO, name, lastname, dateBorn, address, trainingLevel, Long.toString(phone), email, name+" "+lastname, password1, password2, role, Long.toString(identifyCard));
